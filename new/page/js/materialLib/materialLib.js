...
jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		...
		datatype: "local",
		height: 250,
		colNames:['素材编号','素材名称','上传人','所属行业','路径','文件大小','机构','来源'],
		colModel:[
			...
			{name:'user',index:'user', width:80, editable: true,edittype:"select",editoptions:{value:"FE:已使用;IN:未使用"}},
			{name:'publish',index:'publish', width:70, editable: true,edittype:"select",editoptions:{value:"FE:已使用;IN:未使用"}},
			{name:'industry',index:'industry', width:150, editable: true,edittype:"select",editoptions:{value:"FE:已发布;IN:未发布"}},
			{name:'type',index:'type', width:80, editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
			{name:'show',index:'show', width:90, sorttype:"int", editable: true},
			{name:'theme',index:'theme',width:150, editable:true, sorttype:"date",unformat: pickDate}
